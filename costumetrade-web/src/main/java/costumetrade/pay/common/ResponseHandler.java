...
import costumetrade.pay.utils.TenpayUtil;
...
public class ResponseHandler {
	...
	private static final String appkey = ConfigProperties.getProperty("wx.aes.key");
	/** 密钥 */
	private String key;
	...
	public ResponseHandler(HttpServletRequest request,
		...
		this.debugInfo = "";
		this.uriEncoding = "";
		this.parameters=ServiceUtil.convertStreamToTreeMap(request);
	}
